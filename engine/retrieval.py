...
def get_retrieved_docs(q, c, s, sw):
    ...
    inv_ind = pickle.load(open("/home/ashishu007/IR-Engine/engine/pkls/inverted_index_{}_stem_{}_stop_removal_{}.pkl".format(c, s, sw), "rb"))
    file_content = pickle.load(open("/home/ashishu007/IR-Engine/engine/pkls/file_content_{}_stem_{}_stop_removal_{}.pkl".format(c, s, sw), "rb"))
